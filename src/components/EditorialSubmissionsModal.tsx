    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-xs">
      <div className="bg-[#ffffff] border-2 border-[#781f1d]/40 rounded-2xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-2.5 bg-[#f2ebe7] border-b border-[#cfb6b3] flex flex-wrap items-center justify-between gap-3 text-xs sm:text-sm font-semibold">
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="px-1.5 py-0.5 rounded-full text-[10px] bg-[#781f1d] text-white font-bold leading-none">8</span>
            </button>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
          ...
          {/* TAB: PUBLISHED PAPERS REPOSITORY */}
          {activeTab === 'server-pdfs' && (
            <div className="space-y-6 text-sm text-[#421413]">
              ...
              <div className="p-4 sm:p-5 bg-[#ffffff] border border-[#cfb6b3] rounded-xl space-y-3">
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-center gap-2.5">
                    <div className="p-2 bg-[#f2ebe7] rounded-lg text-[#781f1d]">
                      <FileText className="w-5 h-5" />
                    </div>
                    <div>
                      <h4 className="font-serif font-bold text-base text-[#1f0707]">
                        Published Article Repository
                      </h4>
                      <p className="text-xs text-[#581e1d]">
                        All published articles are permanently preserved and accessible within the journal repository.
                      </p>
                    </div>
                  </div>
                  <span className="inline-flex items-center gap-1.5 text-xs font-bold text-[#781f1d] bg-[#f2ebe7] border border-[#cfb6b3] px-3 py-1 rounded-full shrink-0">
                    <FileText className="w-3.5 h-3.5 text-[#781f1d]" />
                    8 Published Papers
                  </span>
                </div>

                <p className="text-xs text-[#581e1d] leading-relaxed">
                  Open-access scholarly manuscripts published in SGRCR are indexed with digital DOIs and open-access licensing. Readers and indexing bodies can read full texts with zero barriers.
                </p>
              </div>
              ...
              <div className="p-4 sm:p-5 bg-[#ffffff] border border-[#cfb6b3] rounded-xl space-y-4">
                <h5 className="font-serif font-bold text-sm text-[#1f0707] flex items-center justify-between">
                  ...
                  <span className="text-xs font-mono text-[#781f1d]">Repository: SGRCR Articles</span>
                </h5>
                    ...
                    >
                      <div className="space-y-1 flex-1">
                        <div className="flex flex-wrap items-center gap-2 text-xs">
                          ...
                          <span className="text-[11px] bg-[#f2ebe7] text-[#781f1d] px-1.5 py-0.2 rounded font-semibold border border-[#cfb6b3]">
